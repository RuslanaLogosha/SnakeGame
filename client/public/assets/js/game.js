...
var Game = {
  preload: function () {
    //  load all the needed resources for the level.
    game.load.image('snake', './assets/images/snake.png');
    game.load.image('apple', './assets/images/apple.png');
  },

  create: function () {
    snake = []; // parts of snake
    apple = {}; // apple;
    squareSize = 15; // length of a side of the squares.
    score = 0;
    speed = 0;
    ...
    // Generate the initial snake length
    for (var i = 0; i < 10; i++) {
